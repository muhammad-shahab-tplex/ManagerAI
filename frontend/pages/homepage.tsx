  ...
  return (
    <div className="home-container">
      ...
      <section className="features-section">
        <h2>How YourManager Works For You</h2>
        <div className="features-grid">
          <div className="feature-card">
            ...
            <h3>Email Digest + Smart Reply</h3>
            <p>Filter important emails and generate context-aware replies that match your writing style.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
            ...
            <p>Intelligently schedule meetings, suggest focus blocks, and optimize your calendar.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
            </div>
            <h3>Daily Brief Generator</h3>
            <p>Start your day with a smart summary of meetings, emails, and priorities.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
            ...
            <p>Get pros/cons lists and personalized recommendations for important decisions.</p>
          </div>
        </div>
      </section>
      ...
      <section className="testimonials-section">
        ...
        <div className="testimonials-container">
          <div className="testimonial-card">
            <p>"YourManager saved me at least 2 hours daily on email management alone. It's like having an executive assistant that knows exactly how I think."</p>
            <div className="testimonial-author">
              <span>Sarah J.</span>
              <span className="author-title">Startup Founder</span>
            </div>
          </div>
          <div className="testimonial-card">
            <p>"The calendar organization feature is a game-changer. I never realized how much time I was wasting on scheduling until YourManager took over."</p>
            <div className="testimonial-author">
              <span>Michael T.</span>
              <span className="author-title">CEO</span>
            </div>
          </div>
        </div>
      </section>
